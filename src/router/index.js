...
import homePage from '../controllers/home_page'
import homeNine from '../controllers/home_nine'
import homeClass from '../controllers/home_class'
import homeMe from '../controllers/home_me'
import top from '../controllers/top'
import topRank from '../controllers/top_rank'
...
export default class Router {
  constructor(obj) { // 生命周期函数
    ...
    this.routes = {
      ...
      '/index/top': top,
      '/index/error': error,
      '/index/home/page': homePage,
      '/index/home/nine': homeNine,
      '/index/home/class': homeClass,
      '/index/home/me': homeMe,
      '/index/top/rank': topRank,
    }
    // 组件挂载根元素
    this.root = $('#main')
    // 导航菜单列表
  ...
  hashRefresh(e) {
    ...
    // 获取当前路径,默认'/index'
    var currentURL = location.hash.slice(1).split('?')[0] || '/index/home/page';
   ...
   */
  navActive(item) {
    $('.tabbar a').filter(`[href="#${item}"]`).closest('li').addClass('active').siblings().removeClass('active')
  }
}